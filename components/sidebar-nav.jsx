  ...
  return (
    <div className="space-y-1">
      {items && items.length > 0 ? (
        ...
        p-2 text-sm font-medium rounded-lg border-l border-gray-700 hover:border-blue-950 ${
          isOpen ? 'text-white' : 'text-gray-400 hover:bg-blue-800 hover:text-white border-l border-gray-700 hover:border-blue-950'
        }`}>
          {title}
          {isOpen ? (
        ...
        <Link href={href}>
          <p className="block p-2 text-sm text-gray-400 rounded-lg border-l border-gray-700 hover:border-blue-950
            ...
            <div key={index}>
              {item.items ? (
                ...
                <Link href={item.href}>
                  ...
                  border-gray-700 rounded-xl hover:border-blue-950">{item.title}</p>
                </Link>
              )}
            </div>
          ))}
